...
console.log(parseInt(phone))
  ...
  return (
     <div className='w-screen h-screen fixed z-50 inset-0 bg-black bg-opacity-30 backdrop-blur-sm  flex justify-center items-center'>
            <div  className='lg:w-[30%] md:w-[40%] w-[80%] h-[70%] bg-white p-5 pl-10 pr-10'>
            <div  className=' justify-start items-center w-[71%]'>
             <div className='flex justify-between'>
             <img onClick={() => onModelClose(false)} className='w-7' src={chevron} />
                <h2 className='flex justify-center text-xl text-[#D4821F]'>اضافة زبون جديد</h2>
            </div>
            </div>
